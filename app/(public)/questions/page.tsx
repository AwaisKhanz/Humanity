...
export default async function QuestionsPage() {
  try {
    ...
    if (!Array.isArray(questions)) {
      console.error("Questions response is not an array:", questions);
      notFound();
    }

    // Serialize data to ensure no non-serializable fields
    ...
    const featuredQuestion = serializedQuestions.length > 0 ? serializedQuestions[0] : null;
    ...
    console.error("Error rendering QuestionsPage:", error);
    notFound();
  }
}